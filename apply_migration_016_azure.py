#!/usr/bin/env python3
"""
Script pour appliquer la migration 016 sur Azure
"""
import os
import sys
...
# DATABASE_URL Azure
DATABASE_URL = "postgresql://admincocoa:CocoaTrack2024!@cocoatrack-db-20251129201729.postgres.database.azure.com:5432/cocoatrack?sslmode=require"

print(f"🔗 Connexion à Azure PostgreSQL...")
...
try:
    with engine.connect() as conn:
        ...
        print("\n✅ Migration 016 appliquée avec succès sur Azure!")
        print("\n📋 Résumé:")
